            ...
            <div class="grid grid-cols-1 gap-6 px-8 text-center md:px-0 md:grid-cols-3">
                <div class="overflow-hidden bg-white rounded-xl">
                    <div class="p-6">
                        ...
                        <p class="mt-6 text-lg font-medium text-gray-900">+252 61700009</p>
                        <p class="mt-1 text-lg font-medium text-gray-900">+252 61500089</p>
                    </div>
                </div>
                ...
                <div class="overflow-hidden bg-white rounded-xl">
                    <div class="p-6">
                        ...
                        <p class="mt-6 text-lg font-medium text-gray-900">Booking@Fliaght.com</p>
                        <p class="mt-1 text-lg font-medium text-gray-900">Booking@Kq.com</p>
                    </div>
                </div>
